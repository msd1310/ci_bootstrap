...
?>
                ...
                <div class="col-lg-4 col-sm-4">
                    ...
                    echo form_dropdown('parktype',$parktype,set_value('parktype',$p_type),$attributes);?>
                ...
                <div class="col-lg-4 col-sm-4">
                <input type="text" placeholder = "From Date" name = "fromdate" id="datepicker" class="datepicker" value="<?php echo set_value('fromdate',$f_date); ?>"/>
                ...
                <div class="col-lg-2 col-sm-2">
                    ...
                    echo form_dropdown('fromtime',$fromtime,set_value('fromtime'),$attributes);?>
              </div>
                 </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-4">
                <input type="text" id="datepicker1"  placeholder = "To Date"  name = "todate" class="datepicker" value="<?php echo set_value('todate',$t_date); ?>"/>
                <span class="fa fa-calendar fa-2x"></span></div>
                <div class="col-lg-2 col-sm-2">
                ...
                <div class="col-lg-2 col-sm-2">
                    ...
                    echo form_dropdown('totime',$fromtime,set_value('totime'),$attributes);?>
              </div>
			...
			<thead style="background-color:#ECF0F5;">
                    ...
                    <tbody>
                         <?php $charges_t = 0;
                              ...
                              <tr id="hide-row_<?php echo $i;?>" class="hiderow" hidden>
			            ...
			            <td>Total </td><td>OUT (<?php echo $i; ?>)</td><td></td><td colspan=2></td><td><?php echo $charges_t; ?>
                    </table>
