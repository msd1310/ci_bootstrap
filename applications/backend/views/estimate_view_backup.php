...
<body>
	...
	?>
		...
		<!--input id="btn_add" name="btn_add" type="submit" class="btn btn-danger" onclick="setHiddenValue('excel')" value="Export To Excel" hidden-->
...
<!--	<a href="#" onClick ="$('#dataTables-example').tableExport({type:'excel',escape:'false'});">XLS</a>
    ...
    <div class="col-lg-12">
		...
		<?php $charges_t = $charges_t + $total_charges;
			...
			<td>Total </td><td>IN (<?php echo $i; ?>)</td><td></td><td colspan=2></td><td><?php echo $charges_t; ?>
                    </table>
